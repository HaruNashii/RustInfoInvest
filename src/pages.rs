...
pub fn calculator_page() -> Page<'static>
{
    ...
    unsafe
    {
        ...
        all_text.push(gen_text(20.0, (226, 275), format!("Return in {}", YEARS_INVESTED   ), subtext_color) );
        all_text.push(gen_text(20.0, (226, 325), format!("Return in {}", MONTHS_INVESTED  ), subtext_color) );
        all_text.push(gen_text(20.0, (226, 375), format!("Return in {}", DAYS_INVESTED    ), subtext_color) );
        all_text.push(gen_text(20.0, (226, 425), format!("Return in {}", HOURS_INVESTED   ), subtext_color) );
        all_text.push(gen_text(20.0, (226, 475), format!("Return in {}", MINUTES_INVESTED ), subtext_color) );
        all_text.push(gen_text(20.0, (226, 525), format!("Return in {}", SECS_INVESTED    ), subtext_color) );
        ...
        {
            Some(4) =>  { all_text.remove(4 + 4);  all_text.push(gen_text(18.0, (all_buttons[0].2.x + 10, all_buttons[0].2.y + 7), format!("Year Return Value: {}%", USER_INPUT), default_text_color)); },
            Some(5) =>  { all_text.remove(5 + 4);  all_text.push(gen_text(18.0, (all_buttons[1].2.x + 10, all_buttons[1].2.y + 7), format!("Total Invested: R${}",   USER_INPUT), default_text_color)); },
            Some(6) =>  { all_text.remove(6 + 4);  all_text.push(gen_text(20.0, (226, 275), format!("Return in {}", USER_INPUT), subtext_color)); },
            Some(7) =>  { all_text.remove(7 + 4);  all_text.push(gen_text(20.0, (226, 325), format!("Return in {}", USER_INPUT), subtext_color)); },
            Some(8) =>  { all_text.remove(8 + 4);  all_text.push(gen_text(20.0, (226, 375), format!("Return in {}", USER_INPUT), subtext_color)); },
            Some(9) =>  { all_text.remove(9 + 4);  all_text.push(gen_text(20.0, (226, 425), format!("Return in {}", USER_INPUT), subtext_color)); },
            Some(11) => { all_text.remove(11 + 4); all_text.push(gen_text(20.0, (226, 525), format!("Return in {}", USER_INPUT), subtext_color)); },
            Some(10) => { all_text.remove(10 + 4); all_text.push(gen_text(20.0, (226, 475), format!("Return in {}", USER_INPUT), subtext_color)); },
            Some(12) => { all_text.remove(12 + 4); all_text.push(gen_text(18.0, (all_buttons[8].2.x + 10, all_buttons[8].2.y + 7), format!("Monthly Contribution: R${}", USER_INPUT), default_text_color)); },
            _=> { },
        };
    };
...
pub fn investment_wallet_page() -> Page<'static>
{
    ...
    unsafe 
    {
        all_text.push(gen_text(18.0, (all_buttons[1].2.x + 10, all_buttons[1].2.y + 7), format!("Return Value: {}%",    RETURN_PER_INVESTMENT),         default_text_color));
        all_text.push(gen_text(18.0, (all_buttons[2].2.x + 10, all_buttons[2].2.y + 7), format!("Total Invested: R${}", TOTAL_INVESTED_PER_INVESTMENT), default_text_color));
        all_text.push(gen_text(18.0, (all_buttons[3].2.x + 10, all_buttons[3].2.y + 7), format!("Investment Name: {}",  INVESTMENT_NAME),               default_text_color));
        all_text.push(gen_text(18.0, (all_buttons[6].2.x + 10, all_buttons[6].2.y + 7), format!("Year: {}",             YEAR),                          default_text_color));
        all_text.push(gen_text(18.0, (all_buttons[7].2.x + 10, all_buttons[7].2.y + 7), format!("Month: {}",            MONTH),                         default_text_color));
        all_text.push(gen_text(18.0, (all_buttons[8].2.x + 10, all_buttons[8].2.y + 7), format!("Day {}",               DAY),                           default_text_color));

        match IS_ON_WRITE_MODE.1
        {
            Some(16) => { all_text.remove(3); all_text.push(gen_text(18.0, (all_buttons[1].2.x + 10, all_buttons[1].2.y + 7), format!("Return Value: {}",    USER_INPUT), default_text_color)); },
            Some(17) => { all_text.remove(4); all_text.push(gen_text(18.0, (all_buttons[2].2.x + 10, all_buttons[2].2.y + 7), format!("Total Invested: {}",  USER_INPUT), default_text_color)); },
            Some(18) => { all_text.remove(5); all_text.push(gen_text(18.0, (all_buttons[3].2.x + 10, all_buttons[3].2.y + 7), format!("Investment Name: {}", USER_INPUT), default_text_color)); },
            Some(21) => { all_text.remove(6); all_text.push(gen_text(18.0, (all_buttons[6].2.x + 10, all_buttons[6].2.y + 7), format!("Year: {}",            USER_INPUT), default_text_color)); },
            Some(22) => { all_text.remove(7); all_text.push(gen_text(18.0, (all_buttons[7].2.x + 10, all_buttons[7].2.y + 7), format!("Month: {}",           USER_INPUT), default_text_color)); },
            Some(23) => { all_text.remove(8); all_text.push(gen_text(18.0, (all_buttons[8].2.x + 10, all_buttons[8].2.y + 7), format!("Day: {}",             USER_INPUT), default_text_color)); },
            _=> {},
        };
        ...
        {
            all_text.push(gen_text(10.0, (30, 327 + (index * 40) as i32),  format!("Name:{}   Rate:{}%   Total Invested: R${}   Date: {}", investment.3, investment.1, investment.2, investment.0.format("%Y-%m-%d")), default_text_color));
        };
    }
