...
pub fn persistent_page() -> Page<'static>
{
    ...
    [
        //header background
        (BLACK_COLOR, Rect::new(0, 0, 800, 100)),
    ];
    ...
    [
        ...
        //secound page button
        (true, PINK_COLOR, Rect::new(300, 10, 200, 75), 2),
        //selic page button
...
pub fn calculator_page() -> Page<'static>
{
    ...
    [
        ...
        (ORANGE_COLOR, Rect::new(10, 215, 385, 40)),
        (ORANGE_COLOR, Rect::new(405, 215, 385, 40)),
    ];
    ...
    [
        ...
        (true, PURPLE_COLOR, Rect::new(10, 160, 780, 40), 5),
        //year button
        (true, BLACK_COLOR,  Rect::new(345, 275, 40, 25), 6),
        //month button
        (true, BLACK_COLOR,  Rect::new(345, 325, 40, 25), 7),
        //day button
        (true, BLACK_COLOR,  Rect::new(345, 375, 40, 25), 8),
        //hour button
        (true, BLACK_COLOR,  Rect::new(345, 425, 40, 25), 9),
        //minute button
        (true, BLACK_COLOR,  Rect::new(345, 475, 40, 25), 10),
        //secs button
        (true, BLACK_COLOR,  Rect::new(345, 525, 40, 25), 11),
...
pub fn realtime_currency_page() -> Page<'static>
{
    ...
    [
        ...
        (PURPLE_COLOR, Rect::new(405, 105, 385, 40)),
    ];
...
pub fn investment_wallet_page() -> Page<'static>
{
    ...
    for index in 0..(unsafe{ALL_INVESTMENTS.len()})
    {
        ...
        all_rects.push((BLACK_COLOR, Rect::new(20, 320 + (index * 40) as i32, 730, 30)));
    }
    ...
    [
        ...
        (true, PURPLE_COLOR, Rect::new(20, 200, 350, 40), 16),
        //total invested return value button
        (true, PURPLE_COLOR, Rect::new(400, 200, 350, 40), 17),
        //investment name button
        (true, PURPLE_COLOR, Rect::new(20, 140, 730, 40), 18),
        //add investment button
        (true, ORANGE_COLOR, Rect::new(100, 20, 650, 40), 19),
        //delete all investment button 
        (true, PINK_COLOR, Rect::new(20, 80, 730, 40), 20),
        //year button 
        (true, PINK_COLOR, Rect::new(20, 260, 230, 40), 21),
        //month button 
        (true, PINK_COLOR, Rect::new(270, 260, 230, 40), 22),
        //day button 
        (true, PINK_COLOR, Rect::new(520, 260, 230, 40), 23),
    ];
    ...
    [
        ...
        gen_text(18.0, (all_buttons[4].2.x + 245, all_buttons[4].2.y + 7),  "Add Investment".to_string(), TEXT_COLOR),
        gen_text(18.0, (all_buttons[4].2.x + 200, all_buttons[5].2.y + 7),  "Remove All Investments".to_string(), TEXT_COLOR),
    ];
    ...
    {
        all_text.push( gen_text(14.0, (690, rect.1.y + 5), "Remove".to_string(), TEXT_COLOR) );
    };
